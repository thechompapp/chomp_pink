...
const ListCard = React.memo(({
    ...
    item_count = 0,
    is_following,
    created_by_user = false, // Add this prop from backend
}) => {
    ...
    const isOwnList = created_by_user || (listFromUserStore && listFromUserStore.created_by_user); // Check if user created this list
