...
const DraggableListItem = ({ item, index, moveItem, getDetailPageUrl, handleQuickAdd, isOwnedByUser }) => {
  ...
  return (
    <li 
      ref={isOwnedByUser ? (node) => drag(drop(node)) : null}
      className={`hover:bg-gray-50 ${isDragging ? 'opacity-50 bg-pink-50' : ''}`}
    >
