...
// Reusable Similar Dish Card Component
const SimilarDishCard = ({ dish, onQuickAdd }) => (
  <div className="border border-gray-200 rounded-lg p-3 hover:border-pink-200 hover:bg-pink-50">
    <h3 className="font-medium">{dish.name}</h3>
    <div className="text-xs text-gray-600 mt-1">{dish.price}</div>
    <div className="mt-2 flex justify-between items-center">
      ...
      <button
        ...
        onClick={(e) => onQuickAdd(e, dish.id, 'dish')}
...
const DishDetail = () => {
  ...
  const dish = {
    ...
    lists: [
      { id: 301, name: "Best Pasta in NYC", by: "@pastafan", followers: 423 },
      { id: 302, name: "Simple but Perfect Dishes", by: "@minimalchef", followers: 286 },
      { id: 303, name: "Must Try in West Village", by: "@nycfoodie", followers: 568 },
    ],
    similarDishes: [
      { id: 401, name: "Carbonara at Lilia", price: "$22", rating: 4.7 },
      { id: 402, name: "Tagliatelle al Ragù at L'Artusi", price: "$26", rating: 4.8 },
      { id: 403, name: "Bucatini all'Amatriciana at I Sodi", price: "$24", rating: 4.6 },
    ],
    theTake: {
      author: "Maria Rossi",
      profile: "@pastaexpert",
    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-6">
        <div className="flex flex-col md:flex-row justify-between">
          <div>
            ...
            <Link
              to={`/restaurant/${dish.restaurant.toLowerCase().replace(/\s+/g, '-')}`}
              className="text-xl text-pink-600 mt-1 block hover:text-pink-800"
            >
              at {dish.restaurant}
            </Link>
          ...
          <div className="flex mt-4 md:mt-0">
            ...
            <button
              onClick={() => handleQuickAdd(event, dish.id, 'dish')}
            ...
            <div className="flex items-center space-x-3 bg-gray-100 rounded-full px-3 py-1">
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M3.293 9.707a1 1 0 010-1.414l6-6a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L10 5.414V17a1 1 0 11-2 0V5.414L3.293 9.707z"
                    clipRule="evenodd"
                  />
                </svg>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        ...
        <div className="p-4 grid gap-3">
          {dish.lists.map((list) => (
            <FeaturedListCard key={list.id} list={list} onQuickAdd={handleQuickAdd} />
          ))}
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-3">
          {dish.similarDishes.map((similar) => (
            <SimilarDishCard key={similar.id} dish={similar} onQuickAdd={handleQuickAdd} />
          ))}
        </div>
      </div>
