...
vi.mock('../../doof-backend/db/database.js');
vi.mock('../../doof-backend/middleware/auth.js');
vi.mock('bcrypt');
...
describe('Backend Integration Tests', () => {
  ...
  describe('Authentication Controller Integration', () => {
    test('should integrate login with user validation and token generation', async () => {
      ...
      // Mock password validation (bcrypt was already imported and mocked at the top)
      bcrypt.compare.mockResolvedValue(true);

      // Mock JWT token generation (jwt was already imported and mocked at the top)
    ...
    test('should integrate token refresh with validation', async () => {
      // jwt is already imported and mocked at the top
      const decoded = { userId: 'user-1' }; // Mocked decoded token
      jwt.verify.mockReturnValue(decoded);
      const result = jwt.verify('test-token', 'test-secret');
  ...
  describe('Places Controller Integration', () => {
    test('should integrate place search with Google Places API and caching', async () => {
      ...
      // axios is already imported and mocked at the top
    ...
    test('should handle cached results and skip API calls', async () => {
      ...
      // axios is already imported and mocked at the top
      axios.get.mockClear(); // Clear any previous mock calls
  ...
  describe('Error Handling Integration', () => {
    ...
    test('should handle external API failures with fallbacks', async () => {
      // Mock Google Places API failure (axios is already imported and mocked at the top)
