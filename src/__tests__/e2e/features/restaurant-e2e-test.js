...
import { describe, it, before, after, beforeEach, afterEach, vi } from 'vitest';
import { expect } from 'chai';
import { login, register, getRestaurants, createRestaurant } from '../setup/robust-api-client.js';
import { generateTestUser } from '../setup/test-users.js';
import { initializeDatabase, cleanupDatabase } from '../setup/db-init.js';
