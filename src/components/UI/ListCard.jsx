      ...
      <div className="w-72 h-64 bg-[#D1B399] bg-opacity-10 border border-[#D1B399] rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
        <div className="h-full flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link
              to={`/lists/${id}`}
              className="py-2 border border-[#D1B399] text-[#D1B399] rounded-lg hover:bg-[#D1B399] hover:text-white transition-colors text-center text-sm font-medium"
            >
              View
            </Link>
            ...
            <button
              ...
              className="py-2 border border-[#D1B399] text-[#D1B399] rounded-lg flex items-center justify-center font-medium hover:bg-[#D1B399] hover:text-white transition-colors"
            >
