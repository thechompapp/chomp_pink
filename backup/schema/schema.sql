...
CREATE TABLE public.lists (
    ...
    CONSTRAINT lists_list_type_check CHECK (((list_type)::text = ANY (ARRAY[('restaurant'::character varying)::text, ('dish'::character varying)::text, ('mixed'::character varying)::text])))
);
