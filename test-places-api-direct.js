/**
 * Direct Google Places API Test Script
 * 
 * This script tests the Google Places API integration directly
 * to identify issues with the bulk add functionality.
 */
...
// Configuration
const config = {
  apiKey: process.env.GOOGLE_PLACES_API_KEY || '', // Will be read from environment
  testQueries: [
...
async function runTests() {
  ...
  if (!config.apiKey) {
    ...
    console.log('\nPlease set the GOOGLE_PLACES_API_KEY environment variable and try again:');
