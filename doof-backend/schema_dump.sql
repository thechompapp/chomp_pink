...
--
-- Name: idx_list_items_item_id; Type: INDEX; Schema: public; Owner: doof_user
--

CREATE INDEX idx_list_items_item_id ON public.list_items USING btree (item_id);


--
-- Name: idx_list_items_list_id; Type: INDEX; Schema: public; Owner: doof_user
--
...
--
-- Name: list_items list_items_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: doof_user
--
