/**
 * Browser API Test Runner
 * 
 * This script runs API tests in a browser-like environment using happy-dom,
 * which helps avoid CORS issues that occur in JSDOM.
 */
...
/**
 * Run a test file with the browser configuration
...
async function runTest(testFile) {
  ...
  // Run the test using Vitest with the browser config
 ...
 */
async function main() {
  console.log('🔍 Browser API Test Runner');
  console.log('=========================');
