...
CREATE TABLE public.users (
    ...
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT users_account_type_check CHECK (((role)::text = ANY ((ARRAY['user'::character varying, 'contributor'::character varying, 'superuser'::character varying])::text[])))
);
...
--
-- Name: neighborhoods unique_name_city_id; Type: CONSTRAINT; Schema: public; Owner: doof_user
--

ALTER TABLE ONLY public.neighborhoods
    ADD CONSTRAINT unique_name_city_id UNIQUE (name, city_id);
...
CREATE INDEX idx_users_account_type ON public.users USING btree (role);
...
--
-- Name: dishes dishes_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: doof_user
--

ALTER TABLE ONLY public.dishes
    ADD CONSTRAINT dishes_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);
...
--
-- Name: restaurants restaurants_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: doof_user
--
