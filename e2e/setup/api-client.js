 ...
 * 
 * This file provides a standardized API client for E2E tests.
 */

import axios from 'axios';
import { config } from './config.js';

// Create a simple in-memory storage for tokens (Node.js compatible)
const tokenStorage = {
  token: null,
  setItem(key, value) {
    this[key] = value;
...
const apiClient = axios.create({
  ...
  timeout: config.api.timeout * 2, // Increased timeout
  headers: {
